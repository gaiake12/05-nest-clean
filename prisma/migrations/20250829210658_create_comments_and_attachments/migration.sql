...
-- AddForeignKey
ALTER TABLE "comments" ADD CONSTRAINT "comments_authro_id_fkey" FOREIGN KEY ("authro_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
